...
<style>
  ...
  .cat {
    ...
    font-size: min(0.05vh, 0.05vw);
    font-size: min(0.03vh, 0.03vw);
    --color: #615656;
    --color: #0baadc;
  ...
  @keyframes cat {
    50% {
      transform: translateX(-50%) rotateX(75deg) rotateZ(-180deg);
    }
    100% {
  ...
  .lightsource {
    ...
    transform-origin: center;
    transform: translate(-50%, -50%) rotateX(0deg) rotateY(0deg) rotateX(20deg)
      translateZ(2500em);
  }
  .lightsource div {
    width: var(--side);
  ...
  .lightsource-0 {
    transform: translate(calc(var(--side) * 0.31), calc(var(--side) * 0.16))
      translateZ(calc(var(--side) * -0.85)) rotateX(100.7deg);
  }
